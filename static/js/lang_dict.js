const LANG_DICT = {
    "id": {
        ...
        "hint_tpl_bill": "Gunakan {id}, {name}, {month}, {price}, {expired}, {x} untuk variabel dinamis.",
        "hint_tpl_bill_auto": "Gunakan {id}, {name}, {month}, {price}, {expired}, {x} untuk variabel dinamis.",
        ...
        "hint_tele_tpl": "Gunakan {name}, {ip}, {status}, {date}, {time}, {total_online}, {total_offline}, {packet} untuk variabel dinamis.",
        ...
        "hint_tpl_pay_desc": "Gunakan <b>{id}</b>, <b>{name}</b>, <b>{amount}</b>, <b>{date}</b>",
        ...
        "hint_tpl_isolir": "Terkirim saat klien diisolir. Gunakan {id}, {name}, {price}, {expired}.",
        ...
        "hint_tpl_reactivate": "Terkirim saat layanan aktif kembali setelah bayar. Gunakan {id}, {name}, {amount}, {date}, {expired}.",
        ...
        "hint_conf_cycle_m": "Siklus Bulanan: Penagihan serentak. Semua client jatuh tempo di tanggal yang sama (Global).",
        "hint_conf_cycle_c": "Siklus 30 Hari: Penagihan individual. Jatuh tempo mengikuti tanggal pasang masing-masing klien (Personal).",
        "hint_conf_grace": "Grace Period: Masa toleransi. Jika diisi 3, isolir dilakukan pada hari ke-4 setelah jatuh tempo.",
        "hint_conf_isolir_mk": "Profil Isolir: Wajib sama dengan nama 'Profile' di MikroTik (Wajib limit kecepatan rendah).",
        ...
        "hint_conf_auto_isolir": "Auto-Isolir: Jika OFF, sistem hanya lapor tunggakan tanpa memutus koneksi.",
        ...
        "card_arrears_subtitle": "Daftar client yang masa aktifnya sudah habis",
        ...
        "hint_arrears_calc": "Angka Tagihan: Dihitung otomatis dari (Harga Paket x Jumlah Bulan Nunggak) + Ajustmen Manual.",
        ...
        "ph_search_name_ip": "Cari Nama/IP...",
    ...
    "en": {
        ...
        "th_host": "HOST",
        // CLIENT PAGE
        "pg_client_search": "Search Name / IP...",
        "btn_dl_excel": "DOWNLOAD EXCEL",
        "btn_import_bulk": "IMPORT BULK",
        "th_name": "Client Name",
        "th_paket": "Package",
        ...
        "hint_tpl_pay_desc": "Use <b>{id}</b>, <b>{name}</b>, <b>{amount}</b>, <b>{date}</b>",
        "hint_tpl_bill": "Use {id}, {name}, {month}, {price}, {expired}, {x} for dynamic variables.",
        "hint_tpl_bill_auto": "Use {id}, {name}, {month}, {price}, {expired}, {x} for dynamic variables.",
        ...
        "hint_tpl_isolir": "Sent when client is isolated. Use {id}, {name}, {price}, {expired}.",
        "hint_tpl_reactivate": "Sent when service is back online after payment. Use {id}, {name}, {amount}, {date}, {expired}.",
        "hint_tpl_pay_desc": "Use <b>{id}</b>, <b>{name}</b>, <b>{amount}</b>, <b>{date}</b>",
        ...
        "card_arrears_subtitle": "List of clients whose active period has expired",
        ...
        "hint_arrears_calc": "Total Due: Automatically calculated as (Package Price x Overdue Months) + Manual Adjustment.",
        ...
        "ph_search_name_ip": "Search Name/IP...",
